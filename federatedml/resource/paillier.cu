...
void init_pub_key(void *g, void *n, void *nsquare, void *max_int) {
  ...
  cudaMemcpy(gpu_pub_key->g, g, CPH_BITS/8, cudaMemcpyHostToDevice);
  cudaMemcpy(gpu_pub_key->n, n, CPH_BITS/8, cudaMemcpyHostToDevice);
  cudaMemcpy(gpu_pub_key->nsquare, nsquare, CPH_BITS/8, cudaMemcpyHostToDevice);
  cudaMemcpy(gpu_pub_key->max_int, max_int, CPH_BITS/8, cudaMemcpyHostToDevice);
}
...
void init_priv_key(void *p, void *q, void *psquare, void *qsquare, void *q_inverse,
  ...
  cudaMemcpy(gpu_priv_key->p, p, CPH_BITS/8, cudaMemcpyHostToDevice);
  cudaMemcpy(gpu_priv_key->q, q, CPH_BITS/8, cudaMemcpyHostToDevice);
  cudaMemcpy(gpu_priv_key->psquare, psquare, CPH_BITS/8, cudaMemcpyHostToDevice);
  cudaMemcpy(gpu_priv_key->qsquare, qsquare, CPH_BITS/8, cudaMemcpyHostToDevice);
  cudaMemcpy(gpu_priv_key->q_inverse, q_inverse, CPH_BITS/8, cudaMemcpyHostToDevice);
  cudaMemcpy(gpu_priv_key->hp, hp, CPH_BITS/8, cudaMemcpyHostToDevice);
  cudaMemcpy(gpu_priv_key->hq, hq, CPH_BITS/8, cudaMemcpyHostToDevice);
}
